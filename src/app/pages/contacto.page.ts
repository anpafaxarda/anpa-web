    ...
    <section class="bg-slate-50 min-h-screen pb-20">
      <div class="bg-slate-900 py-16">
        <div class="container mx-auto px-4 text-center">
          ...
          <p class="text-slate-400 max-w-2xl mx-auto">Estamos aquí para ayudarte. Escríbenos, llámanos o ven a visitarnos a nuestro local en el colegio.</p>
        </div>
      </div>
          ...
          <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 group">
              <div class="flex items-center gap-4 mb-4">
                ...
                <h3 class="font-bold text-slate-800">Teléfono y WhatsApp</h3>
              </div>
              <p class="text-slate-600 mb-4">+34 600 000 000</p>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <p class="text-slate-600">hola&#64;anpa-web.com</p>
              <p class="text-xs text-slate-400 mt-1">Respondemos en menos de 48h</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              <div class="flex items-center gap-4 mb-4">
                ...
                <h3 class="font-bold text-slate-800">Horarios de Atención</h3>
              </div>
              <ul class="space-y-2 text-sm text-slate-600">
                <li class="flex justify-between"><span>Lunes y Miércoles:</span> <span class="font-semibold text-slate-800">16:00 - 18:00</span></li>
                <li class="flex justify-between"><span>Viernes:</span> <span class="font-semibold text-slate-800">09:00 - 11:00</span></li>
                <li class="pt-2 border-t border-slate-50 text-xs italic">Ubicación: Local ANPA (Edificio Principal)</li>
              </ul>
            </div>
