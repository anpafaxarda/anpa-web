...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, PageComponent, SkeletonComponent],
  template: `
    <app-page-component
...
export default class DirectivaPage {
  ...
  ngOnInit() {
    this.seo.setPageMeta(
      this.title,
      'Conoce a las personas que forman la directiva del ANPA A Faxarda y cómo trabajamos de forma voluntaria por el bienestar del alumnado.'
    );
  }
