        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            ...
            <div class="flex gap-4">
              ...
              <a href="https://www.facebook.com/p/Anpa-A-Faxarda-100064561605320/?locale=es_ES" target="_blank" class="bg-slate-800 p-2 rounded-full hover:bg-primary-600 transition-colors">
