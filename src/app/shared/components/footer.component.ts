    ...
    <footer class="bg-surface-900 text-white pt-16 pb-8">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h4 class="font-bold text-xl mb-6 text-primary-400">ANPA Colegio</h4>
            ...
            <div class="flex gap-4">
              <a href="https://www.instagram.com/anpafaxarda/" target="_blank" class="bg-surface-800 p-2 rounded-full hover:bg-pink-600 transition-colors">
              ...
              <a href="https://www.facebook.com/p/Anpa-A-Faxarda-100064561605320/?locale=es_ES" target="_blank" class="bg-surface-800 p-2 rounded-full hover:bg-primary-600 transition-colors">
